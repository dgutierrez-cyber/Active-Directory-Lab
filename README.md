...
4. Objectives:
5. My goal is to perform a Brute Force attack to simulate how easy it is to compromise a device with weak credentials.
...
A Brute Force attack can infiltrate vulnerable accounts
